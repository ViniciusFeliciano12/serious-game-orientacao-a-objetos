...
public class ThirdPersonController : MonoBehaviour
{
    ...
    private float currentJumpingValue = 0f;
    ...
    void Update()
    {
        ...
        if( animator != null ){
            ...
            // Interpole suavemente entre o valor atual e o valor desejado (0 ou 1)
            // currentJumpingValue = Mathf.Lerp(currentJumpingValue, targetValue, transitionSpeed * Time.deltaTime);

            // Defina o valor interpolado no Animator
