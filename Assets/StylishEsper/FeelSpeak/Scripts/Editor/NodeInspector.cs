...
namespace Esper.FeelSpeak.Editor
{
    ...
    public class NodeInspector : DraggableEditorElement
    {
        ...
        public void Refresh()
        {
            ...
            if (dialogueNode != null)
            {
                var defaultCharacterImage = AssetSearch.Find<Texture2D>("FeelSpeak", "Editor/Icons/character_icon.png");
                var defaultEmotionImage = AssetSearch.Find<Texture2D>("FeelSpeak", "Editor/Icons/emotion_icon.png");
