...
namespace Esper.FeelSpeak
{
    ...
    public static class FeelSpeak
    {
        ...
        public static DialogueGraph GetDialogueGraph(int id)
        {
            ...
            if (!dialogue)
            {
                FeelSpeakLogger.LogWarning($"Feel Speak: Dialogue with the ID '{id}' doesn't exist.");
            }
        ...
        public static DialogueGraph GetDialogueGraph(string name)
        {
            ...
            if (!dialogue)
            {
                FeelSpeakLogger.LogWarning($"Feel Speak: Dialogue with the name '{name}' doesn't exist.");
            }
        ...
        public static Character GetCharacter(int id)
        {
            ...
            if (!character)
            {
                FeelSpeakLogger.LogWarning($"Feel Speak: Character with the ID '{id}' doesn't exist.");
            }
        ...
        public static Character GetCharacter(string name)
        {
            ...
            if (!character)
            {
                FeelSpeakLogger.LogWarning($"Feel Speak: Character with the name '{name}' doesn't exist.");
            }
        ...
        public static Emotion GetEmotion(int id)
        {
            ...
            if (!emotion)
            {
                FeelSpeakLogger.LogWarning($"Feel Speak: Emotion with the ID '{id}' doesn't exist.");
            }
        ...
        public static Emotion GetEmotion(string name)
        {
            ...
            if (!emotion)
            {
                FeelSpeakLogger.LogWarning($"Feel Speak: Emotion with the name '{name}' doesn't exist.");
            }
